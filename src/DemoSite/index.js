...
let editable_data = [
  ...
  },
  {
    ...
    readonly: true,
    content:
      "https://netscribes-development.s3.ap-south-1.amazonaws.com/sample_images/Prescription_samples/577734-_2191571372_1656752526.jpg",
    image_url_labelling: {
      annotation: [
        {
          id: "4311718481931721",
          ...
          color: "#f44336",
          points: [
            [0.19441036128152692, 0.1036000327829934],
            [0.19113837764144512, 0.11709696529833084],
            [0.25657805044308113, 0.1195509530283922],
            [0.34819359236537156, 0.1195509530283922],
            [0.3301976823449217, 0.11464297756826948],
            [0.32692569870483984, 0.10114604505293204],
            [0.3056578050443081, 0.09501107572777868],
          ],
          qc_label: false,
          keyframes: "0",
          highlighted: false,
        ...
        {
          id: "8335316008701268",
          cls: "prescription_visit_date",
          open: false,
          type: "polygon",
          color: "#4caf50",
          points: [
            [0.7244717109747786, 0.1232319346234842],
            [0.7261077027948195, 0.14531782419403635],
            [0.8177232447171099, 0.1440908303290057],
            [0.8209952283571916, 0.13059389781366826],
          ],
          qc_label: false,
          keyframes: "0",
          highlighted: false,
        ...
        {
          h: 0.03067484662576689,
          w: 0.3157464212678937,
          x: 0.19441036128152697,
          y: 0.11832395916336153,
          id: "818132691039003",
          cls: "patient_name",
          type: "box",
          color: "#ef6c00",
          ...
          keyframes: "0",
          ocr_value:
            "Dr. Atanu Jana, MBBS, M.S, M.ch (Urology) Consultant Urologist",
          highlighted: false,
          editingLabels: false,
        },
        {
          h: 0.03435582822085881,
          w: 0.22903885480572592,
          x: 0.6590320381731425,
          y: 0.5183239591633617,
          id: "586258361008652",
          cls: "medicine1",
          type: "box",
          color: "#689f38",
          ...
          qc_label: false,
          keyframes: "0",
          ocr_value: "WT. silotime (8)",
          highlighted: true,
          editingLabels: true,
        },
        {
          h: 0.03312883435582825,
          w: 0.2993865030674846,
          x: 0.6475800954328562,
          y: 0.5907165972001714,
          id: "5430955982497692",
          cls: "medicine2",
          type: "box",
          color: "#009688",
          qc_label: false,
          keyframes: "0",
          ocr_value: "USQ RUBP TPVRU .",
          highlighted: false,
          editingLabels: false,
        },
        {
          h: 0.05153374233128838,
          w: 0.3173824130879346,
          x: 0.649216087252897,
          y: 0.633661382476245,
          id: "13338364374488698",
          cls: "medicine3",
          type: "box",
          color: "#2196f3",
          qc_label: false,
          keyframes: "0",
          ocr_value: "Reriev creput. day",
          highlighted: false,
          editingLabels: false,
        },
      ],
  ...
  },
  {
    ...
    history_hide: true,
    readonly: true,
    content: "24-May-2022 11:34 Urology",
  },
  {
    title: "patient_name",
    mandatory: "mandatory",
    ...
    history_hide: true,
    readonly: true,
    content: "Dr. Atanu Jana, MBBS, M.S, M.ch (Urology) Consultant Urologist",
  },
  {
  ...
  },
  {
    ...
    history_hide: true,
    readonly: true,
    content: "WT. silotime (8)",
  },
  {
    title: "medicine_name_with_strength1",
    mandatory: "non-mandatory",
    input_type: "textArea",
    other_value: [],
    default_type: "medicine_name_with_strength1",
    display_label: "medicine_name_with_strength1",
    other_default_value: "",
    history_hide: true,
    readonly: true,
    content: null,
  ...
  },
  {
    ...
    history_hide: true,
    readonly: true,
    content: "USQ RUBP TPVRU .",
  },
  {
    title: "medicine_name_with_strength2",
    mandatory: "non-mandatory",
    input_type: "textArea",
    other_value: [],
    default_type: "medicine_name_with_strength2",
    display_label: "medicine_name_with_strength2",
    other_default_value: "",
    history_hide: true,
    readonly: true,
    content: null,
  ...
  {
    title: "medicine_name_with_strength3",
    mandatory: "non-mandatory",
    input_type: "textArea",
    other_value: [],
    default_type: "medicine_name_with_strength3",
    display_label: "medicine_name_with_strength3",
    other_default_value: "",
    history_hide: true,
    readonly: true,
    content: null,
  ...
  {
    title: "medicine_name_with_strength4",
    mandatory: "non-mandatory",
    input_type: "textArea",
    other_value: [],
    default_type: "medicine_name_with_strength4",
    display_label: "medicine_name_with_strength4",
    other_default_value: "",
    history_hide: true,
    readonly: true,
    content: null,
  ...
  {
    title: "medicine_name_with_strength5",
    mandatory: "non-mandatory",
    input_type: "textArea",
    other_value: [],
    default_type: "medicine_name_with_strength5",
    display_label: "medicine_name_with_strength5",
    other_default_value: "",
    history_hide: true,
    readonly: true,
    content: null,
  ...
  {
    title: "medicine_name_with_strength6",
    mandatory: "non-mandatory",
    input_type: "textArea",
    other_value: [],
    default_type: "medicine_name_with_strength6",
    display_label: "medicine_name_with_strength6",
    other_default_value: "",
    history_hide: true,
    readonly: true,
    content: null,
  ...
  {
    title: "medicine_name_with_strength7",
    mandatory: "non-mandatory",
    input_type: "textArea",
    other_value: [],
    default_type: "medicine_name_with_strength7",
    display_label: "medicine_name_with_strength7",
    other_default_value: "",
    history_hide: true,
    readonly: true,
    content: null,
  ...
  {
    title: "medicine_name_with_strength8",
    mandatory: "non-mandatory",
    input_type: "textArea",
    other_value: [],
    default_type: "medicine_name_with_strength8",
    display_label: "medicine_name_with_strength8",
    other_default_value: "",
    history_hide: true,
    readonly: true,
    content: null,
  ...
  {
    title: "medicine_name_with_strength9",
    mandatory: "non-mandatory",
    input_type: "textArea",
    other_value: [],
    default_type: "medicine_name_with_strength9",
    display_label: "medicine_name_with_strength9",
    other_default_value: "",
    history_hide: true,
    readonly: true,
    content: null,
...
export default () => {
  const [annotatorProps, changeAnnotatorProps] = React.useState({
    ...
    regionClsList: [
      ...
      "hospital_address",
      "medicine1",
      "medicine_name_with_strength1",
      "dosage1",
      "duration1",
      "medicine2",
      "medicine_name_with_strength2",
      "dosage2",
      "duration2",
      "medicine3",
      "medicine_name_with_strength3",
      "dosage3",
      "duration3",
      "medicine4",
      "medicine_name_with_strength4",
      "dosage4",
      "duration4",
      "medicine5",
      "medicine_name_with_strength5",
      "dosage5",
      "duration5",
      "medicine6",
      "medicine_name_with_strength6",
      "dosage6",
      "duration6",
      "medicine7",
      "medicine_name_with_strength7",
      "dosage7",
      "duration7",
      "medicine8",
      "medicine_name_with_strength8",
      "dosage8",
      "duration8",
      "medicine9",
      "medicine_name_with_strength9",
      "dosage9",
      "duration9",
      "medicine10",
      "dosage10",
